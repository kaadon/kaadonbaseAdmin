...
class CommonValidate extends Validate
{
    ...
    protected $rule = [
        ...
        'account|账号' => 'require',
        'username|手机号' => 'require|length:1,32',
        'phone|手机号' => 'require|mobile',
        'nickname|昵称' => 'require|chsAlphaNum',
        ...
        'inviter|推荐人' => 'require|length:6,11|usernameOnly:existent',
        'verify_code|短信验证码' => 'require|number|length:6|smsCode',
        'type|类型' => 'require|in:Common,Ordinary,Sendemail,Sendbeemail',//短信发送类型验证
        ...
        'verify_img_id|图片验证ID' => 'requireWith:verify_img_code|length:32',//图片验证ID验证
